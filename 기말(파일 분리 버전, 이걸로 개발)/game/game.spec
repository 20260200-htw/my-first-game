...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'battle_logic',
        'data.story_data',
        'data.story.story_data_0',
        'data.story.story_data_1_1',
        'data.story.story_data_1_2',
        'data.story.story_data_1_3',
        'data.story.story_data_1_4',
        'data.story.story_data_1_5',
        'data.story.story_data_1_final',
        ...
        'screens.growth_screen',
        'screens.formation_screen',
        'screens.recruit_screen',
        'data.recruit_data',
